...
| Category     | % Objectified | % Text   | % Irrelevant Subject | % Unwanted |
|--------------|---------------|----------|----------------------|------------|
...
**Insert Tribal Eh0z704WsAE0MZt (two people, one with face painted on leg)**
**Insert Nudist_Black E7orQxkXsAQGM-t (person with paiting at the back of face)**
